...
- (void)viewDidLoad {
    ...
    //银联支付
    UIButton *but1 = [[UIButton alloc]initWithFrame:CGRectMake(20, 100, 100, 40)];
    [but1 setTitle:@"银联支付" forState:UIControlStateNormal];
    but1.backgroundColor = [UIColor lightGrayColor];
    [but1 addTarget:self action:@selector(uppay) forControlEvents:UIControlEventTouchUpInside];
...
- (void)uppay
{
     [UPPayPlugin startPay:@"201503111043310091792" mode:@"01" viewController:self delegate:self];
}
